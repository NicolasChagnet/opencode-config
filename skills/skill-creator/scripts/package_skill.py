...
def validate_skill(skill_path: Path) -> list[str]:
    ...
    if "TODO" in frontmatter:
        errors.append(
            "Frontmatter contains TODO placeholders - please complete the description"
        )
    ...
    if name_match:
        ...
        if skill_name != skill_path.name:
            errors.append(
                f"Skill name '{skill_name}' doesn't match directory name '{skill_path.name}'"
            )
    ...
    if "TODO" in body:
        errors.append(
            "SKILL.md body contains TODO placeholders - please complete the content"
        )
